...
func TestPool_Put(t *testing.T) {
	p, err := NewChannelPool(0, 30, 60, factory)
	if err != nil {
		t.Fatal(err)
	}
	defer p.Close()
...
func TestPoolWriteRead(t *testing.T) {
	p, _ := NewChannelPool(0, 30, 60, factory)
...
func TestPoolConcurrent3(t *testing.T) {
	p, _ := NewChannelPool(0, 1, 10, factory)
...
func newChannelPool() (Pool, error) {
	return NewChannelPool(InitialCap, MaximumCap, MaxActive, factory)
}
